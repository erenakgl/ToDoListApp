...
namespace ToDoList.Controllers
{
    public class ToDoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Describtion,IsDone")] ToDo toDo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AJAXCreate([Bind(Include = "Id,Describtion")] ToDo toDo)
        {
            if (ModelState.IsValid)
            {
                string currentUserId = User.Identity.GetUserId();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Describtion,IsDone")] ToDo toDo)
        {
            if (ModelState.IsValid)
            {
